...
function PipelineChart({ stats }: { stats: OverviewStats }) {
  const bars = [
    ...
    { label: "VERIFY", value: stats.withVerify, className: "fill-warning" },
  ];
  ...
  return (
    <Tile className="col-span-2 row-span-2">
      <div className="mb-3 flex items-center justify-between">
        <span className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Generated by pillar</span>
...
export function BentoOverview({ stats, toggles, onToggle }: BentoOverviewProps) {
  return (
    ...
    >
      ...
      />
      <StatTile
        label="⚠ VERIFY to resolve"
        value={stats.withVerify}
